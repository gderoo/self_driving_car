...
def col_cvt(img, color_space = 'RGB'):
    if color_space != 'RGB':
        if color_space == 'HSV':
...
# Rewritten using the single_img_features function
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        # Correct issue of imread with png
        if "png" in file:
...
def slide_window(img, x_start_stop=[None, None], y_start_stop=[None, None],
                 xy_window=(64, 64), xy_overlap=(0.5, 0.5), xy_rand = (10,10)):
